...
4. Open the [Evidence index](evidence.md) and inspect the linked Stellar Expert Testnet transactions. Each proves an uploaded `ContractCode` artifact, not a deployed tournament instance.
...
| Testnet code-upload artifacts | [Evidence index](evidence.md) |
