...
```mermaid
timeline
    title GGG Instawards milestone and evidence timeline
    Week 1 : Deadline-enforced escrow planned
           : Contract behavior, regression coverage, and two refund claims recorded
    Week 2 : Atomic deployment, N-winner, TTL, and read helpers planned
           : Constructor, N-winner, and TTL WASM uploads recorded
           : #220 TTL verification records 67 contract tests
           : 15 September #221 regression snapshot records 72 passing contract tests
    Week 3 : SDK extraction, npm publication, Node.js example, and Testnet redeploy planned
           : No public completion evidence recorded as of 18 September 2026
    Week 4 : Demo, integration guide, and Testnet transaction list planned
           : No public completion evidence recorded as of 18 September 2026
```
