...
Extract the SDK, publish `@ggg/escrow-sdk@0.1.0`, provide a Node.js example, and redeploy the Testnet application. See the [Week 3 plan in the SOW](https://github.com/webnxt-2030/ggg/blob/develop/docs/Instawards_SOW.md).
